    ...
    <section id="album-fisico" className="py-20 bg-gradient-to-br from-amber-50 via-white to-green-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center px-4">
          <div className="mb-6">
            <p className="text-gray-600 text-base sm:text-lg mb-2">Precio especial:</p>
            <p className="text-4xl sm:text-5xl font-bold text-amber-600">{CONFIG.precioAlbum}</p>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 sm:px-10 py-5 bg-green-500 hover:bg-green-600 text-white text-lg sm:text-xl font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 w-full sm:w-auto justify-center"
          >
